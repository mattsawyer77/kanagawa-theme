...
(autothemer-deftheme
 ...
 ((((class color) (min-colors #xFFFFFF))        ; col 1 GUI/24bit
  ...
  (sumiInk-1            "#18171e" "#000000")
  (sumiInk-1b           "#1F1F28" "#080808")
  (sumiInk-1c           "#35353d" "#000000")
  (sumiInk-2            "#2A2A37" "#121212")
  (sumiInk-3            "#222434" "#303030")
  (sumiInk-4            "#54546D" "#303030")
  (waveBlue-1           "#223249" "#4e4e4e")
  (waveBlue-2           "#2D4F67" "#585858")
  (waveAqua1            "#6A9589" "#6a9589")
  (waveAqua2            "#7AA89F" "#717C7C")
  (waveDusk1            "#446677" "#446677")
  (waveDusk2            "#335566" "#335566")
 ...
 (
  ...
  (border                                        (:background sumiInk-0 :foreground sumiInk-0))
  ...
  (header-line                                   (:background sumiInk-1b))
  ...
  (nav-flash-face                                (:background surimiOrange))
  ...
  ;; Battery colors
  (doom-modeline-battery-critical                (:background sumiInk-3 :foreground peachRed))
  (doom-modeline-battery-warning                 (:background sumiInk-3 :foreground springGreen))
  (doom-modeline-battery-charging                (:background sumiInk-3 :foreground fujiGray))
  (doom-modeline-battery-error                   (:background sumiInk-3 :foreground peachRed))
  (doom-modeline-battery-normal                  (:background sumiInk-3 :foreground springViolet1))
  (doom-modeline-battery-full                    (:background sumiInk-3 :foreground waveAqua2))

  ;; Doom visual state
  (doom-modeline-evil-motion-state               (:background sumiInk-3 :foreground lightBlue))
  (doom-modeline-evil-emacs-state                (:background sumiInk-3 :foreground crystalBlue))
  (doom-modeline-evil-insert-state               (:background sumiInk-3 :foreground peachRed))
  (doom-modeline-evil-normal-state               (:background sumiInk-3 :foreground lightBlue))
  (doom-modeline-evil-visual-state               (:background sumiInk-3 :foreground springGreen))
  (doom-modeline-evil-replace-state              (:background sumiInk-3 :foreground roninYellow))
  (doom-modeline-evil-operator-state             (:background sumiInk-3 :foreground crystalBlue))
  ...
  (flycheck-error                                (:underline (:color samuraiRed :style 'wave)))
  (flycheck-warning                              (:underline (:color roninYellow :style 'wave)))
  (flycheck-error-list-warning                   (:background roninYellow :foreground sumiInk-2))
  (flycheck-error-list-error                     (:background samuraiRed :foreground winterRed))
  (flycheck-error-list-info                      (:foreground waveAqua1 :foreground winterBlue))
  (flycheck-inline-error                         (:underline (:color samuraiRed :style 'wave)))
  (flycheck-inline-info                          (:underline (:color lightBlue :style 'wave)))
  (flycheck-inline-warning                       (:underline (:color winterYellow :style 'wave)))
  ...
  (lsp-headerline-breadcrumb-path-face           (:background sumiInk-1b))
  (lsp-headerline-breadcrumb-path-hint-face      (:background sumiInk-1b))
  (lsp-headerline-breadcrumb-path-info-face      (:background sumiInk-1b))
  (lsp-headerline-breadcrumb-separator-face      (:background sumiInk-1b))
  (lsp-headerline-breadcrumb-symbols-face        (:background sumiInk-1b))
  (lsp-headerline-breadcrumb-project-prefix-face (:background sumiInk-1b))
...
;; partial shim to make doom-color work for common color names
;; (require 'doom-themes)
